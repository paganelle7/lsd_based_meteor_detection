...
def one_grad_groop(main_grad_x, main_grad_y, weight_of_groops, x_center, y_center, x_end, y_end, threshold=0.9, weight_un = 8):
...
def lsd_optimysed(main_grad_x, main_grad_y, weight_of_groops, x_center, y_center, x_end, y_end, threshold=0.7, batch_size=5, weight_un=8):
    ...
    main_grad_x, main_grad_y, weight_of_groops, x_center, y_center, x_end, y_end = one_grad_groop(main_grad_x, main_grad_y, weight_of_groops, x_center, y_center, x_end, y_end, threshold=threshold,weight_un=weight_un)
...
def lsd_meteor_on_image(image, threshold=0.9,batch_size=30,weight_un=8):
    ...
    hgrad_x, hgrad_y, hweight_of_groops, hx_center, hy_center,x_end, y_end, m2x,m2y,w2,x2,y2,xe2, ye2 = lsd_optimysed(grad_x.clone(), grad_y.clone(), weight_of_groops.clone(), x_center.clone(), y_center.clone(), x_end.clone(), y_end.clone(), threshold=threshold, batch_size=batch_size,weight_un=weight_un)
    # 
